  ...
  return (
    <div className="space-y-12 text-md md:text-lg text-gray-300 bg-gray-900 pb-4 md:pb-8 p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105 duration-300">
      ...
      <p className="text-gray-200">
        Introducing Convert.io, the ultimate multimedia conversion powerhouse
      ...
      <div className="space-y-2">
        ...
        <p className="text-gray-200">
          ...
          need to resize, crop, rotate, or convert formats, I've got you
      ...
      <div className="space-y-2">
        ...
        <p className="text-gray-200">
          Unlike other services, I believe in empowering your creativity without
          hidden fees or restrictions. You can convert as many images, audio
          files, and videos as your heart desires, and it won't cost you
          anything.
        </p>
      </div>
      ...
      <div className="space-y-2">
        ...
        <p className="text-gray-200">
          Access Convert.io from any device with an internet connection. Whether
      ...
      <div className="space-y-2">
        ...
        <p className="text-gray-200">
          Intuitive Interface is designed for both beginners and experts, making
      ...
      <div className="space-y-2">
        ...
        <p className="text-gray-200">
          I am committed to staying ahead of the curve. Expect regular updates
